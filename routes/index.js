    ...
    return function(req, res) {
        ...
        */
        ...
        function processResults(req,res){
            ...
            retCnt=0
            genColl=collegeDB.collection("univs")
        ...
        coll = collegeDB.collection("univs")//.find({"_id":/effy/});   // enrollments
        coll2= collegeDB.collection("univs")//.find({"_id":f1a});  // financials
        //console.log(coll);
        ...
        coll.aggregate({
                ...
                docs.forEach(function(doc){
                  ...
                  coll2.find({UNITID:doc.UNITID},{UNITID:1, F1D01:1}).toArray(
                      function(err,docs2){
                          // console.log(docs2)
                          if (docs2.length) {
